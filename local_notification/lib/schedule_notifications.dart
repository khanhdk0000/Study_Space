...
class ScheduleNotifications {
  static const MethodChannel _channel =
      const MethodChannel('schedule_notifications');
  ...
  static Future<dynamic> schedule(
      String text, DateTime when, List<int> repeatAt) {
    return _channel.invokeMethod(
        'scheduleNotification', [text, when.toString(), repeatAt]);
  }
